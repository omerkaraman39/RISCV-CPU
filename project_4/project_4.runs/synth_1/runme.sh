...
HD_PWD='C:/Users/omers/project_last/project_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscvCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscvCPU.tcl
